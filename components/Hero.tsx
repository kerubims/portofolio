      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <motion.div variants={item} className="flex flex-wrap gap-3">
            ...
            <a
              href="#contact"
              className="btn-sweep group inline-flex items-center gap-2 rounded-full border border-outline-variant/60 bg-white px-5 py-2.5 font-medium text-foreground shadow-sm transition-colors hover:text-white active:scale-[0.99]"
            >
